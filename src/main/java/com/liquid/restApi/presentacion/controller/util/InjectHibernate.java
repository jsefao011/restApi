package com.liquid.restApi.presentacion.controller.util;
...
public class InjectHibernate  {
    ...
    public static ConsultarPersonaController injectPersonaControllerHibernate(SessionFactory factory){
    ...
    public static ConsultarBaseController<Sexo> injectSexoControllerHibernate(SessionFactory factory){
    ...
    public static ConsultarBaseController<Religion> injectReligionControllerHibernate(SessionFactory factory){
        return new ConsultarBaseControllerImpl<>(
    ...
    public static ConsultarBaseController<Provincia> injectProvinciaControllerHibernate(SessionFactory factory){
        return new ConsultarBaseControllerImpl<>(
    ...
    public static ConsultarBaseController<NivelAcademico> injectNivelAcademicoControllerHibernate(SessionFactory factory){
        return new ConsultarBaseControllerImpl<>(
    ...
    public static ConsultarBaseController<EstadoCivil> injectEstadoCivilControllerHibernate(SessionFactory factory){
        return new ConsultarBaseControllerImpl<>(
    ...
    public static ConsultarBaseController<Distrito> injectDistritoControllerHibernate(SessionFactory factory){
        return new ConsultarBaseControllerImpl<>(
    ...
    public static ConsultarBaseController<Departamento> injectDepartamentoControllerHibernate(SessionFactory factory){
        return new ConsultarBaseControllerImpl<>(
